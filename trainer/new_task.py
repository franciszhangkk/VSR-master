from model import MCFRVSR_model
...
def generator2(filenames):
    ...
    while True:
        ...
        result, l = [np.asarray(batch_list1), np.asarray(batch_list2), low_res_black, high_res_black, flow_pre], [
            np.asarray(label_list1), np.asarray(label_list1)]
        yield result, l
...
if __name__ == '__main__':
    ...
    superes_net = MCFRVSR_model((input_size[1], input_size[0], 3), (output_size[1], output_size[0], 3), (input_size[1], input_size[0], 2))
